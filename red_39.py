...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        pile = arcade.SpriteSolidColor(MAT_WIDTH, MAT_HEIGHT, arcade.csscolor.SLATE_GREY)
        #pile.position = SCREEN_WIDTH//2 + MAT_WIDTH//2, SCREEN_HEIGHT//2 + MAT_HEIGHT//2
        pile.position = SCREEN_WIDTH//2 - 5, SCREEN_HEIGHT//2 - 5
        ...
        #PILE_COUNT = 30
        # v37 cst_GUI added  CANVAS_DECK_PILE = 30
        PILE_COUNT = 31
    ...
    def on_mouse_release(self, x: float, y: float, button: int,
        ...
        print("inside on_mouse_release,  pile = ",pile," distance=",distance)
        ...
        if arcade.check_for_collision(self.held_cards[0], pile):
            ...
            #elif pile_index == CANVAS_DECK_PILE and len(self.held_cards) == 1: # WE PUT A CARD FROM HAND TO CANVAS
            elif pile_index == self.pile_mat_list.index(self.pile_mat_list[-1]):
            
                #print(pile_index)
                #print(self.pile_mat_list.index(self.pile_mat_list[-1]))
    ...
    def menage_PAL_P0(self):
        ...
        for bidul in self.PAL_P0_tab:
            ...
            if not isinstance(bidul, Card):
                ...
                print("\n   ___-----> ",self.PAL_P0_tab.index(bidul),"    ",len(self.PAL_P0_tab),"   ",self.PAL_P0_tab)
        ...
        for i in range(len(PAL_P0)):

            print(type(PAL_P0[i].position))
            print(type(self.pile_mat_list[P0_PAL_0 + i]))

            PAL_P0[i].position = self.pile_mat_list[P0_PAL_0 + i].position
